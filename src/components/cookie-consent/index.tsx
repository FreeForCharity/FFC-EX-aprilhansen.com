...
export default function CookieConsent() {
  ...
  return (
    <div
      className="fixed bottom-0 left-0 right-0 z-50 bg-paper border-t border-rule shadow-[0_-2px_12px_rgba(0,0,0,0.08)]"
      role="region"
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-3">
          ...
          <div className="flex items-center gap-2 shrink-0">
            <button
              ...
              className="px-4 py-1.5 text-[13px] rounded border border-rule text-muted bg-transparent transition-colors hover:bg-rule/20"
            >
              Decline
            </button>
            <button
            ...
            <button
              ...
              className="px-4 py-1.5 text-[13px] rounded font-semibold bg-primary text-white transition-colors hover:bg-primary-soft"
            >
              Accept
            </button>
          </div>
