...
export const metadata: Metadata = {
  ...
  description:
    'Privacy Policy for aprilhansen.com — a memorial site maintained by Free For Charity.',
}
      ...
      <div className="py-[27px] w-[90%] md:w-[80%] mx-auto">
        <div id="aria-font">
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            ...
            country in which analytics cookies are set before you choose. You can change your choice
            at any time via the Cookie Preferences link in the footer of every page.
          </p>
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
